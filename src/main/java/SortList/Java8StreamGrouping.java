...
public class Java8StreamGrouping {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            persons.add(new Person(4, "Dinesh", dateFormat.parse("01/08/1981"), Gender.FEMALE));
            ...
            Map <Gender, Map <Object, String>> byGenderAndId = persons.stream()
                    .collect(Collectors.groupingBy(p -> p.getGender(),
                            Collectors.groupingBy(p -> p.getPersonId(),
                                    Collectors.mapping(p -> p.getName(), Collectors.joining("!!")))));
            ...
            System.out.println("\nGroup By Gender & ID");
            System.out.println(byGenderAndId);
